...
def add_mgm_config(cfg: CN):
    ...
    cfg.MODEL.DEPTH_BACKBONE.DEPTHS = [3, 3, 9, 3]
    cfg.MODEL.DEPTH_BACKBONE.DIMS = [96, 192, 384, 768]
    cfg.MODEL.DEPTH_BACKBONE.DROP_PATH = 0.0
    cfg.MODEL.DEPTH_BACKBONE.LAYER_SCALE = 1e-6
