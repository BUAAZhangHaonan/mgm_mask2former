...
checkpoint_path = "/home/remote1/zhanghaonan/projects/mask2former_0822/test/convnext-checkpoint/mask2former_coco_swin_t.pth"  # 你的权重文件路径
...
if state_dict is None:
    ...
    try:
        ...
        checkpoint_files = [f for f in files if f.endswith('.pkl') or f.endswith('.pth')]
